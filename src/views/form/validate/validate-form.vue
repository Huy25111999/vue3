                    ...
                    <Form @submit="onSubmit" :validation-schema="schema" v-slot="{ errors }">
                        <v-row >
                            <v-col cols="4" sm="4" md="4" pr="6">
                                <div class="form-group col">
                                    <p>Title</p>
                                    <Field v-model.trim="formAddValues.title" placeholder="title" name="title" as="select" class="form-control" :class="{ 'is-invalid': errors.title }">
                            ...
                            <v-col cols="4" sm="4" md="4" pr="6">
                                <div class="form-group col-5">
                                    <p>Last Name</p>
                                    <Field placeholder="Last name"  v-model.trim="formAddValues.lastName"  name="lastName" type="text"  class="form-control" :class="{ 'is-invalid': errors.lastName }" />
                        ...
                        <v-row>
                            <v-col cols="6" sm="6" md="6" pr="6">
                                <div class="form-group col">
                                    <p>Date of Birth</p>
                                    <Field placeholder="Date of Birth"  v-model.trim="formAddValues.dob"  name="dob" type="date" class="form-control" :class="{ 'is-invalid': errors.dob }" />
                            ...
                            <v-col cols="6" sm="6" md="6" pr="6">
                                <div class="form-group col">
                                    <p>Email</p>
                                    <Field placeholder="email" v-model.trim="formAddValues.email"  name="email" type="text" class="form-control" :class="{ 'is-invalid': errors.email }" />
                        ...
                        <v-row>
                            <v-col cols="6" sm="6" md="6" pr="6">
                                <div class="form-group col">
                                    <p>Password</p>
                                    <Field placeholder="Password"  v-model.trim="formAddValues.password"  name="password" type="password"  class="form-control" :class="{ 'is-invalid': errors.password }" />
                            ...
                            <v-col cols="6" sm="6" md="6" pr="6">
                                <div class="form-group col">
                                    ...
                                    <Field placeholder="Confirm password"  v-model.trim="formAddValues.confirmPassword"  name="confirmPassword" type="password" class="form-control" :class="{ 'is-invalid': errors.confirmPassword }" />
                        ...
                        <v-row class="mt-4">
                            <div class="form-check">
                                <Field v-model.trim="formAddValues.acceptTerms"  name="acceptTerms" type="checkbox" id="acceptTerms" value="true" class="form-check-input" :class="{ 'is-invalid': errors.acceptTerms }" />
